      ...
      <div className="flex min-h-screen items-center justify-center bg-black text-white">
        <div className="w-full max-w-md rounded-lg bg-white p-6 text-black shadow-md">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              <label className="mb-2 block text-sm font-semibold">Tanggal Lahir</label>
              <input
                type="date"
                value={tanggalLahir}
            ...
            <div className="mb-4">
              <label className="mb-2 block text-sm font-semibold">Jenis Kelamin</label>
            ...
            <div className="mb-4">
              <label className="mb-2 block text-sm font-semibold">Nama Lengkap Orang Tua</label>
              <input
                type="text"
                value={namaOrangTua}
          ...
          <div className="mb-4">
            ...
            {/* Gizi Kurang */}
            <div className="mb-2">
              <label className="mb-2 block text-sm font-semibold">Gizi Kurang</label>
              <div className="flex gap-6">
                <label className="flex items-center">
                  <input
                    type="radio"
            ...
            {/* Gizi Buruk */}
            <div className="mb-2">
              <label className="mb-2 block text-sm font-semibold">Gizi Buruk</label>
              <div className="flex gap-6">
                <label className="flex items-center">
                  <input
                    type="radio"
            ...
            {/* Stunting */}
            <div className="mb-2">
              <label className="mb-2 block text-sm font-semibold">Stunting</label>
              <div className="flex gap-6">
                <label className="flex items-center">
                  <input
                    type="radio"
          ...
          <div className="mb-4">
            <h3 className="mb-2 text-sm font-semibold">IMUNISASI DASAR LENGKAP</h3>
            {/* HB - O */}
            <div className="mb-2">
            ...
            {/* BCG & Polio 1 */}
            <div className="mb-2">
              <label className="mb-2 block text-sm font-semibold">BCG & Polio 1</label>
              <div className="flex gap-6">
                <label className="flex items-center">
                  <input
                    type="radio"
          ...
          {/* Status Kelengkapan */}
          <div className="mb-4">
            <label className="mb-2 block text-sm font-semibold">STATUS KELENGKAPAN</label>
            <div className="flex gap-6">
              <label className="flex items-center">
                <input
                  type="radio"
